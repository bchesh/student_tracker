class CourseModulesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @course_module.update(course_module_params)
        format.html { redirect_to @course_module, notice: "Course module was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to course_modules_path, notice: "Course module was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_course_module
      @course_module = CourseModule.find(params.expect(:id))
    end
