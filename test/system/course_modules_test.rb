...
class CourseModulesTest < ApplicationSystemTestCase
  ...
  test "should create course module" do
    ...
    fill_in "Notes", with: @course_module.notes
    fill_in "Status", with: @course_module.status
    fill_in "Student", with: @course_module.student_id
  ...
  test "should destroy Course module" do
    visit course_module_url(@course_module)
    accept_confirm { click_on "Destroy this course module", match: :first }
